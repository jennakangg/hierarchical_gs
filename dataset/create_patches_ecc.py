...
ecc_dataset_dir_continous = "playroom_lod_ecc_cont"
import os
...
# ecc_dataset_dir = "playroom_lod_ecc"
# import os
# os.makedirs(ecc_dataset_dir, exist_ok=True)
# lod_ecc_dataset = LODFvvdpEccentricity(ecc_dataset_dir)
...
for view_idx in tqdm(views[18:]):
    for _ in range(10):
        ...
        for _ in range(10):
            ...
            for lod_x in list(reversed(range(levels))):
